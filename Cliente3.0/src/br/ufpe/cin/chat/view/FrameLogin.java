	...
	private void conectar(){
		try {
			...
			if(status == 3){
				...
				JOptionPane.showMessageDialog(this, "Este usu�rio j� est� conectado ao servidor");
				botaoLogin.setEnabled(true);
			}
		} catch (NumberFormatException e) {
			JOptionPane.showMessageDialog(this, "Insira uma porta v�lida");
			botaoLogin.setEnabled(true);
		} catch (UnknownHostException e) {
			e.printStackTrace();
		} catch (IOException e) {
			JOptionPane.showMessageDialog(this, "Falha ao estabelecer conex�o");
			botaoLogin.setEnabled(true);
