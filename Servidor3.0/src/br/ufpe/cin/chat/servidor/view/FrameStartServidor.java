...
public class FrameStartServidor extends javax.swing.JFrame {
	...
	/**
	 * Creates new form FrameStartServidor
	 */
			...
			public void keyPressed(KeyEvent e) {
				if(e.getKeyCode() == KeyEvent.VK_ENTER){
					try{
						...
						JOptionPane.showMessageDialog(null,"Ocorreu um erro ao iniciar servidor");
					}
				}
			}
		});
	...
	private void BotaoIniciarActionPerformed(java.awt.event.ActionEvent evt) {
		try{
			FrameServidor frame = new FrameServidor(Integer.parseInt(TextoPorta.getText()));
			frame.setVisible(true);
			this.dispose();
		}
		catch (IOException e){
			JOptionPane.showMessageDialog(this, "Ocorreu um erro ao iniciar servidor");
		}
	}                                                                    
