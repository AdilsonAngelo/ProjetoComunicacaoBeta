...
import br.ufpe.cin.chat.controle.RTTServer;
...
public class FramePrincipal extends javax.swing.JFrame {
	...
	public FramePrincipal(int porta) throws IOException {
		...
		this.porta = porta;
		serverTransferencia = new ServerSocket(porta+1);
		rttSocket = new ServerSocket(porta+2);
	...
	private void initComponents() {
		...
		(new Thread(new RTTServer(servidor, rttSocket))).start();
	}// </editor-fold> 
